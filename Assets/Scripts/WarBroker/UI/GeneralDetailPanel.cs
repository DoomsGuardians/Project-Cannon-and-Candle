...
public class GeneralDetailPanel : WindowBase
{
    ...
    private Text txtIntent;
    private Text txtIntentSource;

    [Header("操作按钮")]
    private Button btnReinforce;
    private Text txtReinforceCost;
    private Button btnOverride;
    private Dropdown ddOverrideType;
    private Text txtOverrideCost;
